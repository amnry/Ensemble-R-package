...
#' If x is numeric and y is categorical, ANOVA or Fisher's Exact Test is conducted depending on the number of levels in x.
#' If x is categorical and y is numeric, Kruskal-Wallis test is used for non-parametric analysis.
